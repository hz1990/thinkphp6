<?php /*a:1:{s:52:"F:\www\www.study.com\app\admin\view\index\index.html";i:1609997165;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <![endif]-->
    <title><?php echo config('config.title'); ?></title>
    <meta name="keywords" content="<?php echo config('config.keywords'); ?>">
    <meta name="description" content="<?php echo config('config.description'); ?>">
</head>
<body>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/index'); ?>" data-title="管理员管理" href="javascript:void(0)">管理员管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="<?php echo url('goods/seckill'); ?>" data-title="秒杀管理" href="javascript:void(0)">秒杀管理</a></li>
                </ul>
            </dd>
        </dl>
    </div>
